...
const uint32_t BUTTON_CLK[BUTTONn] = {TAMPER_BUTTON_GPIO_CLK,
                                      KEY_BUTTON_GPIO_CLK};
...
void InitIEC_RTC(void){
    ...
    rtc_def.RTC_HourFormat = RTC_HourFormat_24;
    rtc_def.RTC_SynchPrediv = 0x1F3F;  //0x03E7
	  rtc_def.RTC_AsynchPrediv = 0x7C;
